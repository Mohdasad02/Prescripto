 ...
 const {calculateAge, slotDateFormat, currency} = useContext(AppContext)
  ...
  return (
    <div className='w-full max-w-6xl m-5 '>
       ...
       <div className='bg-white border border-1 border-gray-200 rounded text-sm max-h-[80vh] overflow-y-scroll'>
       ...
       {appointments.map((item,index) => (
           <div key={index} className='flex flex-wrap justify-between max-sm:gap-2 sm:grid sm:grid-cols-[0.5fr_3fr_1fr_3fr_3fr_1fr_1fr] items-center text-gray-500 py-3 px-6 border border-1 border-gray-200 hover:bg-gray-50'>
            <p>{index+1}</p>
