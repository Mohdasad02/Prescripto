  ...
  return profileData && (
    <div>
      ...
      <div className='flex flex-col gap-4 m-5'>
        ...
        <div>
          <img className='bg-[#5f5fff] w-full sm:max-w-64 rounded-lg' src={profileData.image} alt="" />
        </div>
        ...
        <div className='flex-1 border border-stone-100 rounded-lg p-8 py-7'>
...

             {
              isEdit 
              ? 
              <button onClick={updateProfile} className='px-4 py-1 border border-[#5f5fff] text-sm rounded-full mt-5 hover:bg-[#5f5fff] hover:text-white transition-all cursor-pointer'>Save</button>
                
              : <button onClick={() => setIsEdit(true)} className='px-4 py-1 border border-[#5f5fff] text-sm rounded-full mt-5 hover:bg-[#5f5fff] hover:text-white transition-all cursor-pointer'>Edit</button> 
