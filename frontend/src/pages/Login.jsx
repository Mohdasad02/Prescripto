  ...
  return (
    <form onSubmit={onSubmitHandler} className='min-h-[80vh] flex items-center'>
      ...
      <div className='flex flex-col gap-3 m-auto items-start p-8 min-w-[340px] sm:min-w-96 border rounded-xl text-[#5E5E5E] text-sm shadow-lg'>
        ...
        <p>Please {state === 'Sign Up' ? 'sign up' : 'log in'} <span>to book an appointment</span></p>

        {state === 'Sign Up' && 
             <div className='w-full '>
             <p>Full Name</p>
             <input className='border border-[#DADADA] rounded w-full p-2 mt-1' type="text" value={name} onChange={(e) => setName(e.target.value)}/>
           </div>
        }
